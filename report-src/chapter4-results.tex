...
\textsuperscript{$\ddagger$}\small These two ablations produced bit-identical metrics across all evaluation categories, despite differing in whether seasonal features are present in the CNN input. Surprisingly, both of them present a higher skill than the base model..
\end{flushleft}
\end{table}
